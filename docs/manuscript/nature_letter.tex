...
There are a likely to be a large number of mechanisms by which epistasis may occur, as evidenced by the functional analaysis of our discovery set. Therefore it is not surprising that epistasis should be widespread. Further research is required to elucidate specific mechanisms by which statistical epistasis manifests from molecular action, and to quantify the contribution of epistasis to the genetic variance of complex traits.
