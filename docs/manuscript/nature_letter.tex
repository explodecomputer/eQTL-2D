...
We cross referenced our list of interactions with a map of chromosome interacting regions in K562 blood cell lines. Forty-nine epistatic interactions mapped to within 50kb of a chromosome interaction, and 69 mapped to within 2Mb ($p < 1.0 \times 10^{-4}$ in both cases). 
