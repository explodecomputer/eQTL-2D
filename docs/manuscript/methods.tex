...
To compare the relative contribution of genetic variance between additive and epistatic variances one would ideally take all the possible additive effects 
