...
The probability of observing the number of concordant signs is calculated using a binomial test. All variance decompositions were calculated using the NOIA method \cite{Alvarez-Castro2008}.
